...
import { X } from '@admin-core/icons';
import {
  Separator,
  Sheet,
  SheetClose,
...
const getAppendTo = computed(() => {
  return appendToMain.value
    ? `#${ELEMENT_IDS.MAIN_CONTENT}>div:not(.absolute)>div`
    : undefined;
});
...
<template>
  ...
  >
    ...
    >
        ...
        <div class="flex items-center">
          ...
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <AdminHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </AdminHelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <AdminLoading v-if="showLoading || submitting" spinning />
      <SheetFooter
        v-if="showFooter"
        :class="
          cn(
